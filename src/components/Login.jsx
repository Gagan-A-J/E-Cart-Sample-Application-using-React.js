      ...
      <div className="flex h-screen flex-col justify-center px-6 py-12 lg:px-8 bg-gray-600">
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm shadow-lg p-3 rounded-md shadow-white-500">
                    <form action="#" method="POST" className="space-y-6">
                        ...
                        <div>
                            <button type="submit" className="flex w-full justify-center rounded-md bg-indigo-500 px-3 py-1.5 text-sm/6 font-semibold text-white hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 cursor-pointer"
                            onClick={handleLogin}
                            >Sign in</button>
                        </div>
                    </form>
